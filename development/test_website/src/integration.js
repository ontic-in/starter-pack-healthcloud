...
// TODO: Replace these values with your Salesforce staging org's configuration
...
// Initialize embedded messaging service for Staging Environment
...
function initEmbeddedMessaging() {
  try {
    ...
    window.addEventListener('onEmbeddedMessagingReady', () => {
      console.log('Embedded messaging ready (Staging Environment)');
    });

    // Initialize the embedded service with staging configuration
    embeddedservice_bootstrap.init(AGENT_ID, AGENT_NAME, AGENT_URL, {
      scrt2URL: '[SALESFORCE_SCRT2_URL_STAGING]'
    });
