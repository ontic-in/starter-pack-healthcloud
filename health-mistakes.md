...
# Implementation Mistakes & Learnings - [US-1.1.4] Patient Search & Duplicate Detection
...
## Mistake 14: Original Implementation Had 13 Reviewable Issues
...
| # | Mistake | Severity | Time Lost |
|---|---------|----------|-----------|
| 14 | 13 PR review findings in original impl | High | ~45 min (review + fix cycle) |
